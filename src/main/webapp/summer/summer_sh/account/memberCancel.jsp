...
<div class="container body-top">
	...
	<form action="${pageContext.request.contextPath}/account/uDelete"
		method="post" id="form">
		<fieldset>
			<legend class="text-center">${sessionScope.userid}님 회원 탈퇴
				페이지</legend>
			...
			<div class="form-group">
				<label for="inputPass">비밀 번호 입력(*)</label> <input type="password"
					class="form-control" id="inputPass" name="userpass"
				...
				<div class="col-sm-6">
					<p>
						<a href="javascript:history.go(-1);"
							class="btn btn-danger btn-block">취 소</a>
					</p>
				</div>
			</div>
		</fieldset>
